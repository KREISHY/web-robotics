        ...
        <>
            <Container className="main-container">
                ...
                <Row>
                    <Col>
                        <Text className="mainText hidden ">
                            Наши соревнования предоставляют участникам уникальную возможность продемонстрировать свои разработки, улучшить свои навыки и получить ценный опыт работы в команде. Мы гордимся тем, что помогаем создавать новые стартапы, поддерживаем креативные идеи и вносим вклад в развитие науки и технологий. Присоединяйтесь к нам, чтобы стать частью будущего инженерии!"
                        </Text>
                    </Col>
                    <Col>
